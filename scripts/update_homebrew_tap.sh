...
ZIP_PATH="${ZIP_PATH:-${ROOT_DIR}/dist/LayerKeys.zip}"
SHA_PATH="${ROOT_DIR}/dist/LayerKeys.sha256"
...
cat > "${TAP_REPO}/Casks/layerkeys.rb" <<EOF
cask "layerkeys" do
  version "${VERSION}"
  sha256 "${SHA256}"
...
echo "Updated ${TAP_REPO}/Casks/layerkeys.rb"
